...
import jp.keitai2013.practice.keiziban.chikara.manager.CUtil;
...
//			"foo@example.com:hello", "bar@example.com:world" };
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mSignUpBtn = (Button) findViewById(R.id.register_btn);
	...
	public void attemptLogin() {
		...
		else if( !CUtil.isEisuuzi(mPassword) ) {
